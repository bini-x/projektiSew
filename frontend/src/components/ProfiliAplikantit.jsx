  ...
  return (
    <div className="max-w-5xl mx-auto mb-8 mt-10 px-4">
      ...
      <div className="bg-white rounded-3xl shadow-sm overflow-hidden mb-6 border border-[#D6E6F2]">
        {/* Cover Banner */}
        <div className="h-32 bg-gradient-to-r from-[#B9D7EA] to-[#769FCD]"></div>
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-wrap gap-2">
            {perdoruesiData?.aftesite?.map((aftesi, index) => (
              <div key={index} className="group relative">
                <span className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#D6E6F2] to-[#B9D7EA] text-[#769FCD] rounded-xl text-sm font-medium">
                  {aftesi}
                </span>
                <button
