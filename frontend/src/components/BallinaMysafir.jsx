    ...
    <div className="relative">
      ...
      <div className="relative min-h-[700px] flex flex-col items-center justify-start overflow-hidden pt-32">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, rgba(15, 76, 117, 0.6), rgba(109, 148, 197, 0.5), rgba(15, 76, 117, 0.7))",
          }}
        />
      ...
      {/* Two Column Section */}
      <div
        className="ballinaMysafir"
        style={{
          background: "linear-gradient(to bottom right, #e8f1f8, #d4e4f2)",
        }}
      >
        <div className="containerballinamysafir bg-white/80 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300">
          <h1 className="text-2xl font-semibold" style={{ color: "#0f4c75" }}>
            Po punësoni talentë?
          </h1>
          ...
          <button
            ...
            onMouseEnter={(e) =>
              (e.target.style.background =
                "linear-gradient(to right, #0d3d5e, #5a7dad)")
            }
            onMouseLeave={(e) =>
              (e.target.style.background =
                "linear-gradient(to right, #0f4c75, #6d94c5)")
            }
